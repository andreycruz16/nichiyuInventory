          ...
          <form role="form" class="form-horizontal" action="login.php" method="post">
            ...
            <h4 class="modal-title" id="exampleModalLabel">Login Form</h4><br>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-sm btn-success btn-block">Login</button><br>
            ...
            <!--     <form action="login.php" method="post">
                  ...
                  <button type="submit" class="btn btn-sm btn-default btn-block">Login as Service Personnel</button>
                </form> -->
              </div>
        </div>
      </div>
