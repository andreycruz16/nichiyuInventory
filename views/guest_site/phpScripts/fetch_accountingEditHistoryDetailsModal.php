        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
                        ...
                        <?php 
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while($row = mysqli_fetch_array($result, MYSQL_NUM)) { 
                                    ...
                                    $referenceName = $row[1];
                        ?>
                            <option value="<?php echo $reference_id; ?>" <?php if($referenceType == '<?php echo $referenceName; ?>') echo "selected"; ?>><?php echo $referenceName; ?></option>
              ...
              <div class="col-md-6">
                <!-- <div class="text-left"><strong>Original Quantity: <?php echo $quantity; ?></strong></div><br> -->
                <!-- <input type="hidden" value="<?php echo $quantity; ?>" id="originalQuantity" placeholder="0"> -->
                <div class="input-group col-md-12">
...
<!--                 <div class="input-group col-md-12">
                    <span class="input-group-addon" id="basic-addon1"><label class="text-danger"></label> New Quantity:</span>
                    <input type="number" name="quantity" value="<?php echo $quantity; ?>" class="form-control" id="quantityTotal" placeholder="0" aria-describedby="basic-addon1" readonly required autocomplete="off">
                </div><br> -->
...
<script>
          ...
          // $(document).ready(function() {
          //   $('#quantityChange').keyup(function(event) {
          //     var quantityChange = $('#quantityChange').val();
          //     var quantityTotal = $('#originalQuantity').val();              
          //     var total = parseInt(quantityChange) + parseInt(quantityTotal);
