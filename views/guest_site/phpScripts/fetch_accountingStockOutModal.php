...
<!--             <div class="form-group">
            ...
            <form role="form" class="form-horizontal" action="phpScripts/stockOut.php" method="post">  
                ...
                <div class="input-group col-md-12">
                    ...
                    <input type="text" name="referenceNumber" class="form-control" id="referenceNumber" placeholder="Reference Number" aria-describedby="basic-addon1" required autocomplete="off">
                </div>
                <br>
                <div class="input-group col-md-12">
