        ...
        <div class="col-md-10">               
            ...
            <form role="form" class="form-horizontal" action="phpScripts/stockIn.php" method="post">  
                ...
                <div class="input-group col-md-12">
                    ...
                    <input type="text" name="referenceNumber" class="form-control" id="referenceNumberModal" placeholder="Reference Number" aria-describedby="basic-addon1" required autocomplete="off">
                    <input type="text" name="receivingReport" class="form-control" id="receivingReportModal" placeholder="Receiving Report" aria-describedby="basic-addon1" autocomplete="off">
                </div>
                <br>
                <div class="input-group col-md-12">
