                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                    <a href="itemReportWarehouse.php?item_id=<?php echo $item_id; ?>&amp;partNumber=<?php echo $partNumber; ?>&amp;description=<?php echo $description; ?>&amp;quantity=<?php echo $quantity; ?>" target="_blank" class="btn btn-primary btn-block btn-md"><b>Generate Report</b>&nbsp;&nbsp;<span class="glyphicon glyphicon glyphicon-print"></span></a>
                                </div>                                
                            </div>
                        </div>
                    </div>                   
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="text-center">
                                    <form role="form" class="form-horizontal" target="_blank" action="itemCustomReportWarehouse.php" method="post">
