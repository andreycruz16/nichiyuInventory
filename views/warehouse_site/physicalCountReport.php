...
$pdf->SetTitle('WarehouseReport_PhysicalCount_'.date('F-d-y', strtotime($GLOBALS['date'])));
...
$pdf->Output('WarehouseReport_PhysicalCount_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
