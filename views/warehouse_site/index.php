		...
		<div id="page-wrapper">
            <div class="header"> 
                <h2 class="page-header">
                    <code class="text-success">WAREHOUSE&nbsp;DEPARTMENT</code>
                </h2>
                <ol class="breadcrumb">
...
<!--                                 <div class="panel-left pull-left blue">
                                ...
                                <div class="panel-right">
                                   ...
                                   <div align="left" style="font-size:15px"><strong> <a href="index.php" style="color:white">Total # of Items</a></strong></div><br>
                                </div>
                            </div>
                        </div>
                        <!-- LOW STOCKS     -->
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3">
                            <div class="panel panel-primary text-center no-boder <?php if($GLOBALS['outOfStocks'] > 0) echo "red"; else echo "blue"; ?>">
                                <div class="panel-right">
                                   ...
                                   <div align="left" style="font-size:15px"><strong> <a href="#" id="outOfStocksFilter" style="color:white">Total # of Out of Stocks</a></strong></div><br>
                                </div>
                            </div>
                        </div>                        
