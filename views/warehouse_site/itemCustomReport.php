...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'ITEM TRANSACTION REPORT', 0, 0, 'C');
...
$pdf->SetTitle('Warehouse_CustomItemReport_'.$description.'_'.$dateFrom.'_'.$dateTo);
...
$pdf->Output('Warehouseg_CustomItemReport_'.$description.'_'.$dateFrom.'_'.$dateTo.'.pdf', 'I');
