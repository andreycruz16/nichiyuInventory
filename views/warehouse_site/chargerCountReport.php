...
$pdf->SetTitle('WarehouseReport_ChargerCount_'.date('M-d-y'));
...
// WHERE
// tbl_item_history.userType_id = 4
...
$pdf->Output('WarehouseReport_ChargerCount_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
