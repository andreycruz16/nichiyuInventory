...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'OUT OF STOCKS', 0, 0, 'C');
...
$pdf->SetTitle('WarehouseReport_OutOfStocks_'.date('M-d-y'));
...
$pdf->Output('WarehouseReport_LowStocks_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
