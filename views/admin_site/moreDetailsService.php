      ...
      <?php include("includes/sideNavigation.php") ?>
        ...
        <div class="header"> 
            <h2 class="page-header">
                <spaan class="text-success">(Service) <?php echo strtoupper($description); ?></spaan>
            </h2>
            <ol class="breadcrumb">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" name="description" id="description" class="form-control" value="<?php echo $description; ?>" aria-describedby="basic-addon1" disabled readonly required>
                            </div>
                         </div>
                      </div>
                      <div class="form-group input-group col-md-12">
                                ...
                                <table class="table table-striped table-bordered table-condensed table-hover" id="recordHistory">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" bgcolor="#f2ba7f">Unit&nbsp;Cost</th>
                                    ...
                                    <?php 
                                        ...
                                        $sql = "SELECT 
                                               ...
                                               AND userType_id = ".$_SESSION['userType_service']."
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">₱ <?php echo $unitCost; ?></td>
