		...
		<div id="page-wrapper">
            <div class="header"> 
                <h2 class="page-header">
                    <span class="text-success">Part Number: <?php echo $partNumber; ?></span>
                </h2>
                <ol class="breadcrumb">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                    <a href="itemReportAccounting.php?item_id=<?php echo $item_id; ?>&amp;partNumber=<?php echo $partNumber; ?>&amp;description=<?php echo $description; ?>&amp;quantity=<?php echo $quantity; ?>" target="_blank" class="btn btn-primary btn-block btn-md"><b>Generate Report</b>&nbsp;&nbsp;<span class="glyphicon glyphicon glyphicon-print"></span></a>
                                </div>                                
                            </div>
                        </div>
                    </div>                   
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="text-center">
                                    <form role="form" class="form-horizontal" target="_blank" action="itemCustomReportAccounting.php" method="post">
                                        ...
                                        <button type="submit" class="btn btn-block btn-md btn-primary"></span> <b>Generate Report</b>&nbsp;&nbsp;<span class="glyphicon glyphicon glyphicon-print"></span></button>
                                    </form>
                                </div>
                            </div>
                        </div>
