...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'FORKLIFT UNITs COUNT', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_UnitCount_'.date('M-d-y'));
...
$pdf->Output('ServiceReport_UnitCount_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
