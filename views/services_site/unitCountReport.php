...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'ALL UNITS REPORT', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_AllUnitsReport_'.date('M-d-y'));
...
$pdf->Output('ServiceReport_PartCount_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
