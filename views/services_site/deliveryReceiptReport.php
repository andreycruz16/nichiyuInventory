...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'DOCUMENT TYPE: Delivery Receipt', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_DeliveryReciept_'.date('M-d-y'));
...
$pdf->Output('ServiceReport_DeliveryReceipt_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
