...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'CHARGER UNITS COUNT', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_ChargerCount_'.date('M-d-y'));
...
$pdf->Output('ServiceReport_ChargerCount_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
