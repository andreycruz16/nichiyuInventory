...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'DOCUMENT TYPE: PhysicalCount', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_PhysicalCount_'.date('M-d-y'));
...
$sql = "SELECT
        ...
        INNER JOIN tbl_reference AS r ON (h.reference_id = r.reference_id)
        WHERE i.userType_id = ".$_SESSION['userType_id']."
        AND i.status = 0
        AND r.reference_id = 6
...
$pdf->Output('ServiceReport_PhysicalCount_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
