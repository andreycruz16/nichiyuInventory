...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'DOCUMENT TYPE: Pick Up Order', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_PickUpOrder_'.date('M-d-y'));
...
$pdf->Output('ServiceReport_PickUpOrder_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
