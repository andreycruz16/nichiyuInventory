...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'DOCUMENT TYPE: Invoice', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_Invoice_'.date('M-d-y'));
...
$pdf->Output('ServicegReport_Invoice_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
