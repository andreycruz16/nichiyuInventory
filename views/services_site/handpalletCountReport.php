...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'HAND PALLET TRUCKS COUNT', 0, 0, 'C');

        $this->Ln();
        $this->SetFont('helvetica', 'R', 10);
        $this->Cell(0, 0, 'Service Department', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_HandPalletCount_'.date('M-d-y'));
...
<table rules="all" border=".5" width="100%">
        <tr style="background-color:#555; color:#fff;">
            ...
            <th align="center" width="25%"> Model/Brand/Specification</th>
            <th align="center" width="25%"> Serial Number</th>
            <th align="center" width="15%"> Quantity</th>
            <th align="center" width="15%"> Unit Cost</th>
            <th align="center" width="15%"> Total Cost</th>
        </tr>';
...
$pdf->Output('ServiceReport_HandPalletCount_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
