...
<!--             <div class="form-group">
            ...
            <form role="form" class="form-horizontal" action="phpScripts/stockOut.php" method="post">  
                ...
                <div class="input-group col-md-12">
                    ...
                    <input type="text" name="model" class="form-control" id="model" placeholder="Model (Optional)" aria-describedby="basic-addon1" autocomplete="on">
                    <input type="text" name="serialNumber" class="form-control" id="serialNumber" placeholder="Serial Number (Optional)" aria-describedby="basic-addon1" autocomplete="on">
                </div>
                <br>
