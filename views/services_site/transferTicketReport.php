...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'DOCUMENT TYPE: Transfer Ticket', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_TransferTicket_'.date('M-d-y'));
...
$pdf->Output('ServiceReport_PurchaseOrder_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
