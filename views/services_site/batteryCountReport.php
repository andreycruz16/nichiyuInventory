...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'BATTERY UNITS COUNT', 0, 0, 'C');
...
$pdf->SetTitle('ServiceReport_BatteryCount_'.date('M-d-y'));
...
$pdf->Output('ServiceReport_BatteryCount_'.date('F-d-y', strtotime($GLOBALS['date'])).'.pdf', 'I');
