...
<!--                 <div class="input-group col-md-12">
                    ...
                    <div class="input-group date form_date col-md-12">
                        <input id="date" name="date" class="form-control" type="date" value="<?php echo date('Y-m-d'); ?>" placeholder="YYYY-MM-DD" required readonly>
                    </div>
                </div> -->
                <!-- <br> -->
                <div class="input-group col-md-12" id="partNumberForm">
                    ...
                    <input type="text" name="partNumber" class="form-control" id="partNumber" placeholder="Part Number" aria-describedby="basic-addon1" autocomplete="off">
                </div>
                    <div id="status"></div>
                <br>
                <div class="input-group col-md-12">
                    ...
                    <input type="text" name="description" class="form-control" id="" placeholder="Description" aria-describedby="basic-addon1" autocomplete="off">
                </div>
                <!-- <br> -->
                <!-- <div class="input-group col-md-12">
                    ...
                    <select class="form-control" name="reference_id" id="reference_id_add" required>
                        <option value="0" selected disabled>Reference Type</option>
                        <?php 
